...
//isec:-----------------------------------------------
origin_circuit_t *circuit_launch_isec(uint8_t purpose, int flags, float lat, float lon, float Mylat, float Mylon);
origin_circuit_t *circuit_launch_by_extend_info_isec(uint8_t purpose,
                              extend_info_t *extend_info,
                              int flags,float lat, float lon, float Mylat, float Mylon); 
int circuit_stream_is_being_handled_isec(float lat, float lon);
//isec:-----------------------------------------------
